...
## Print this help
help:
	@printf "${TITLE} TangoMan PyHelper ${NL}\n"
	...
	@printf "${WARNING} A collection of useful scripts to use in your Python projects${NL}\n"
...
uninstall:
ifeq (${SYSTEM}, Linux)
	@printf "${INFO}sudo pip3 uninstall -y tangoman-pyhelper${NL}"
	-@sudo pip3 uninstall -y tangoman-pyhelper
	@make clean
endif
